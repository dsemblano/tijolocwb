      ...
      <div class="left-footer">
        <div class="logo-icons flex flex-col items-center justify-between gap-y-10">
          <a class="brand" href="{{ home_url('/') }}">
            <img id="logoname" class="hover:scale-105 transition duration-300 ease-in-out" src={{ Vite::asset('resources/images/logo/tijolologo.webp') }} alt="Tijolo logo" width="134" height="138">
          </a>
