<a class="brand relative" href="{{ home_url('/') }}">
    ...
    @endphp
    <{{$current}}>
      <img id="logoname" class="hover:scale-105 transition duration-300 ease-in-out" src="@asset('images/logo/tijolologo.webp')" alt="Tijolo Restaurante logo" width="104" height="108">
