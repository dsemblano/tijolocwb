<article @php(post_class('nossodiaadia relative'))>
  ...
  <header class="nossodia-header relative bottom-20 w-10/12 m-auto p-4 rounded-t-md bg-tijolocardapio border-t-4 border-tijolo">
      <h2 class="text-center mt-0 text-xl">
