...
<div id="menu-overlay"
    class="animate__animated animate__fadeInDown animate__faster fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center opacity-0 invisible transition-opacity duration-300 z-50 hidden md:hidden">
...
<!-- Menu Toggle Button -->
<button id="menu-toggle" aria-label="Menu" class="lg:hidden mr-4 z-60 bg-transparent border-none focus:outline-none">
...
<div class="hidden justify-between items-center w-full lg:flex lg:order-1" id="mobile-menu-3">
    ...
    {!! wp_nav_menu([
        ...
        'menu_class' => 'flex flex-col pl-4 py-2
                    tracking-widest w-full justify-evenly lg:flex-row lg:mt-0 nav text-white text-lg relative',
        'echo' => false,
    ]) !!}
</div>
