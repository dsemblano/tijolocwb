<header id="header" class="banner w-full z-50 bg-tijolo sticky top-0 left-0 shadow">
    <nav class="nav-primary container py-2 nav-primary">
        <!-- Menu Overlay Mobile -->
        <div id="menu-overlay" class="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center opacity-0 invisible transition-opacity duration-300 z-50 sm:hidden">
