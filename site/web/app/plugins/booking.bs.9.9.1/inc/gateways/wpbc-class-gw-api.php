...
function wpbc_check_payment_status( $payment_status ) {
    ...
    if ( in_array( strtolower( $payment_status ), wpbc_convert__strings_in_arr__to_lower( $payment_success ) ) !== false )   $payment_type = 'success';
    if ( in_array( strtolower( $payment_status ), wpbc_convert__strings_in_arr__to_lower( $payment_pending ) ) !== false )   $payment_type = 'pending';
    if ( in_array( strtolower( $payment_status ), wpbc_convert__strings_in_arr__to_lower( $payment_unknown ) ) !== false )   $payment_type = 'unknown';
    if ( in_array( strtolower( $payment_status ), wpbc_convert__strings_in_arr__to_lower( $payment_error ) ) !== false )     $payment_type = 'error';
