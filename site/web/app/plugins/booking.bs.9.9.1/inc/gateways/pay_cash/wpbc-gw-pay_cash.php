...
//debuge($params);
	    ...
	    $params['cost'] = $params['cost_in_gateway'];
	    $params['cost'] = wpbc_cost_show( floatval( $params['cost_in_gateway'] ), array( 'currency' => wpbc_get_currency() ) );
        ...
        ?></div><?php
/*
		?><div class="pay_cash_div_redirect wpbc-replace-ajax wpbc-payment-form" style="text-align:left;clear:both;display:none;"><?php
		?><ajax_script>
		 	window.location.href = 'https://wpbookingcalendar.com/overview/';
		</ajax_script><?php
		?></div><?php
*/
