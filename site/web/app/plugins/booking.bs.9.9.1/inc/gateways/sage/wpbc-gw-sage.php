...
//return $strPost;
	 ...
	 * We need to open payment form in separate window, if this booking was made togather with other
        ...
        ?><input type="submit" name="submitsagebutton" value="<?php echo $payment_options[ 'payment_button_title' ]; ?>" class="wpbc_button_light wpbc_button_gw wpbc_button_gw_sage" /><?php
        /*
