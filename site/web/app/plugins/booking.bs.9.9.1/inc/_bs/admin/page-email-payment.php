...
//                    );
        ...
        $subtabs['payment_request'] = array( 
                            ...
                            , 'page_title' => __('Emails Settings', 'booking')  // Title of Page   
                            , 'hint' => __('Customization of email template, which is sending to Visitor after payment request' ,'booking')      //FixIn: 8.1.2.17.1
                            , 'link' => ''                                      // link
                            , 'position' => ''                                  // 'left'  ||  'right'  ||  ''
                            , 'css_classes' => ''                               // CSS class(es)
            ...
            <form  name="<?php echo $submit_form_name; ?>" id="<?php echo $submit_form_name; ?>" action="" method="post" autocomplete="off">
                ...
                <div class="metabox-holder">
                    ...
                    <?php 
                        ...
                        wpbc_open_meta_box_section( $submit_form_name . 'general', __('Email with  Payment Request which is sent to Visitor.', 'booking')   );   //FixIn: 8.1.2.17.1
...
//          ) return;
        ...
        //FixIn: 8.1.2.17
		$js_script .= " jQuery('#payment_request_copy_to_admin').on( 'change', function(){ ";
        $js_script .= "     if ( jQuery('#payment_request_copy_to_admin').is(':checked') ) {";
...
function wpbc_send_email_payment_request( $booking_id, $bktype, $formdata, $reason = '') {
    ...
    $previous_active_user = apply_bk_filter( 'wpbc_mu_set_environment_for_owner_of_resource', -1, $bktype );    // MU
        ...
        $replace['paymentreason'] = html_entity_decode( $reason );              //FixIn: 7.0.1.60

        // Replace shortcodes with  custom URL parameter,  like: 'visitorbookingediturl', 'visitorbookingcancelurl', 'visitorbookingpayurl', 'visitorbookingslisting'
