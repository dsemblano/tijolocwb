...
class WPBC_Field_Help_Checkbox extends WPBC_Field_Help_Select{
    ...
    public function setUsingWrapLabelForFields($group_css){ ?>
        <div class="parameter-group <?php echo $group_css; ?>" style="white-space: nowrap;">
            <input type="checkbox"  style="width: auto; padding: 0px; margin: 0 5px 0 0;"
                   id="<?php echo $this->htmlid; ?>_labelwrap" name="<?php echo $this->htmlid; ?>_labelwrap"
                   onchange="javascript:<?php echo $this->update_js_function_name; ?>();"
                   onclick="javascript:this.onchange();"
                   />
            <label class="" for="<?php echo $this->htmlid; ?>_labelwrap" style="width: auto; display: inline;"><?php
            printf(__('Wrap checkbox with a label' ,'booking'),'<code>&lt;label&gt;</code>'); ?>.</label>
        </div>
        <?php
    }
    ...
    public function js(){
        ...
        ?><script type="text/javascript">
            ...
            function <?php echo $this->update_js_function_name; ?>(){
                ...
                if ( jQuery('#<?php echo $this->htmlid; ?>_labelwrap').prop("checked") ) {			//FixIn: 9.8.13.2
