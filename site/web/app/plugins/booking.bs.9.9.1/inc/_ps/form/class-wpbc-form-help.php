    ...
    private function init(){
        ...
        $this->fields[] = array(
            ...
            $this->fields[] = array(
                                ...
                                'help'  => array(
                                  sprintf( __('Booking form supercharged with new simple way to configure rows and several columns for you fields configuration.' ,'booking') , '<strong>' , '</strong>')

                                ,'<strong>'.__('Configuration' ,'booking') . '</strong>'
                                . '<br/>' . __( 'Row: ', 'booking' ) . '<code><strong>&lt;r&gt;...&lt;/r&gt;</strong></code>'
                                . '<br/>' . __( 'Columns: ', 'booking' ) . '<code><strong>&lt;c&gt;...&lt;/c&gt;</strong></code>'
                                . '<br/>' . __( 'Labels: ', 'booking' ) . '<code><strong>&lt;l&gt;...&lt;/l&gt;</strong></code>'
                                . '<br/>' . __( 'Spacer: ', 'booking' ) . '<code><strong>&lt;spacer&gt;&lt;/spacer&gt;</strong></code>'
        ...
        $this->fields[] = array(
                                ...
                                'help'  => array(
                                              ...
                                              , ( ( ($this->version == 'biz_m') || ($this->version == 'biz_l') )?(
                                                ...
                                                . '<br/>'. sprintf(__('Please check more about this feature %shere%s.' ,'booking'),'<a href="https://wpbookingcalendar.com/faq/booking-many-different-items-via-one-booking-form/" target="_blank">','</a>')       
                                                      ):'')
...
//        if ( in_array( $this->version, array('biz_s','biz_m', 'biz_l') ) ) {											//FixIn: TimeFreeGenerator
        ...
        if ( in_array( $this->version, array('biz_s','biz_m', 'biz_l') ) ) {											//FixIn: TimeFreeGenerator
            ...
            $this->fields[] = array(
                               ...
                               , '<strong>'.__('Additional info' ,'booking') . '</strong>'
                                ...
                                .'<br>'.sprintf( __('Please check more about this feature at  %sthis page%s' ,'booking') , '<a href="https://wpbookingcalendar.com/faq/different-time-slots-selections-for-different-days/" target="_blank">' , '</a>')
        ...
        $this->fields[] = array(
                                ...
                                . '<strong>' . __('Example' ,'booking')  .  ':</strong>'  . '<br/>'
                              ...
                              , sprintf( __('%sValidate Text Field for Digits%s.' ,'booking') , '<strong>' , '</strong>' )		//FixIn: 9.8.13.1
                                . '<hr/>'
                                ...
                                . '<strong>' . __('Examples' ,'booking')  .  ':</strong>'  . '<br/>'
        ...
        $this->fields[] = array(
                                ...
                                'help'  => array(
                                	  sprintf( __('%sShow calendar dates legend in any place of booking form.%s' ,'booking') , '<div style="line-height: 1.6em;margin: 0 0 15px;font-size: 18px;">' , '</div>' )
