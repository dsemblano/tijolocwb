...
//		}
                    ...
                    , 'items' => array(     
										array(
                                            ...
                                            , 'action' => " var sel_res_val = document.getElementById('select_default_form_template').options[ document.getElementById('select_default_form_template').selectedIndex ].value;"
                                                        ...
                                                        . "    wpbc_field_highlight( '#select_default_form_template' ); return;"
                                                        . " }"
    ...
    private function show_content_data_form_help( $param ) {
        ...
        <div  class="wpbc-help-message">
            ...
            <span class="description"><?php printf(__('%s - inserting data from fields of booking form' ,'booking'),'<code>[field_name]</code>');?></span><hr/>
            <span class="description wpdevelop"><?php printf(__('%s - custom HTML shortcode, for definition of booking field' ,'booking'),'<code><strong>&lt;f&gt;...&lt;/f&gt;</strong></code>');?>.
				                      <?php _e('Configuration' ,'booking'); echo ': <code><strong>&lt;f&gt;</strong></code><strong>[field_name]</strong><code><strong>&lt;/f&gt;</strong></code>';?></span><br/>
				                      <?php _e('Example' ,'booking');
