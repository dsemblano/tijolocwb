...
//debuge($validated_fields);                
    ...
    public function wpbc_resources_table__show_rows( $row_num, $resource ) {
        ...
        ?><tr class="wpbc_row<?php echo $css_class; ?>" id="resource_<?php echo $resource['id']; ?>"><?php
					...
					<?php if ( ( ! class_exists( 'wpdev_bk_biz_l' ) ) || ( 0 ) ) { ?>
						...
						<div class="wpbc_ajx_toolbar" style="display: flex;flex-flow: row wrap;justify-content: center;align-items: center;margin: 0;">
							<div class="ui_container    ui_container_toolbar		ui_container_small    ui_container_options    ui_container_actions_row_1"
								...
								<div class="ui_group ui_nowrap">
									...
									<div class="ui_element">
										<input type="text"
											   value="[booking resource_id=<?php echo intval( $resource['id'] ); ?>]"
                    ...
                    <td class="wpbc_hide_mobile" style="text-align: center;">
						<a class="button tooltip_top" href="javascript:void(0);" onclick="javascript: wpbc_modal_dialog__show__resource_publish( <?php echo esc_attr( $resource['id'] ); ?> );"
						title="<?php esc_attr_e('Embed your booking form into the page', 'booking'); ?>">
							<?php _e( 'Publish', 'booking' ); ?>
						</a>
                    </td>
        </tr>
        <?php    
