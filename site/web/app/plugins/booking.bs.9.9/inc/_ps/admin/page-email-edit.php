...
//                    );
        ...
        $subtabs['modification'] = array( 
                            ...
                            , 'page_title' => __('Emails Settings', 'booking')  // Title of Page   
                            , 'hint' => __('Customization of email template, which is sent after modification of booking' ,'booking')      //FixIn: 8.1.2.17.1
                            , 'link' => ''                                      // link
                            , 'position' => ''                                  // 'left'  ||  'right'  ||  ''
                            , 'css_classes' => ''                               // CSS class(es)
            ...
            <form  name="<?php echo $submit_form_name; ?>" id="<?php echo $submit_form_name; ?>" action="" method="post" autocomplete="off">
                ...
                <div class="metabox-holder">
                    ...
                    <?php 
                        ...
                        wpbc_open_meta_box_section( $submit_form_name . 'general', __('Email is sent to Visitor after Editing of booking.', 'booking')   );   //FixIn: 8.1.2.17.1
...
//          ) return;
        ...
        //FixIn: 8.1.2.17
		$js_script .= " jQuery('#modification_copy_to_admin').on( 'change', function(){ ";
        $js_script .= "     if ( jQuery('#modification_copy_to_admin').is(':checked') ) {";
...
function wpbc_send_email_modified( $booking_id, $bktype, $formdata ) {
    ...
    $previous_active_user = apply_bk_filter( 'wpbc_mu_set_environment_for_owner_of_resource', -1, $bktype );    // MU
        ...
        foreach ( array( 'visitorbookingediturl', 'visitorbookingcancelurl', 'visitorbookingpayurl', 'visitorbookingslisting' ) as $url_shortcode ) {                     //FixIn: 7.0.1.8            //FixIn: 8.1.3.5.1
            ...
            // Loop to  search  if we are having several such  shortcodes in our $mail_api->fields_values['content']  (For example,  if we have several  languges ). (7.0.1.52)
